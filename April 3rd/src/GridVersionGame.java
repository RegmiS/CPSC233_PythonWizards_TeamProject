...
public class GridVersionGame extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		addStoreItem("Tower 1", "temp.jpg", 1, 1000, 500, 500, 5, 100);
		addStoreItem("Tower 2", "temp.jpg", 2, 750, 250, 700, 4, 50);
		addStoreItem("Tower 3", "temp.jpg", 3, 1500, 750, 2500, 1, 250);
...
//				System.out.println(rec.getId());
    ...
    public static void spawnBase() {
    	Base b1 = new Base(gridpane, 24, 5);
    	textgame.setBase(b1.getY(), b1.getX(), "B");
