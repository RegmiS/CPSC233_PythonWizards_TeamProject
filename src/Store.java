...
public class Store {
	...
	public static void addStoreItem(String name, String image, int position, int price, int HP_val, int DMG_val, int ROF_val, int Range_val) throws FileNotFoundException {
		...
		Button BUY = Buttons.placeTower(price, HP_val, DMG_val, ROF_val, Range_val, Game.getTowerList(), image);
