...
public class Enemy {
	 ...
	 */
	public Enemy(int TILE_SIZE, int heath, Color tier_color, int damage, int radius) {
	...
	public void displayEnemy() {
		pane.getChildren().add(this.circle); //this needs to be in another method
    	animation.play(); //this needs to be in another method
 
    	GridVersionGame.addEnemy(this);
	}

	public Timeline enemyAnimation(double TILE_SIZE)
	{
		double TILE_ADJ = TILE_SIZE / 2.0 - this.radius;
